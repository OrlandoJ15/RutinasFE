  ...
  return (
    <form className="form">
      ...
      <div className="login-with">
        ...
        <div className="button-log">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 56.6934 56.6934" className="icon">
        ...
        <div className="button-log">
          <svg className="icon" viewBox="0 0 56.693 56.693" xmlns="http://www.w3.org/2000/svg">
